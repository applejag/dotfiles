...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, "Shift"   }, "m", function () awful.spawn(beautiful.musicplr) end,
              {description = "run music player", group = "launcher"}),

    awful.key({                   }, "XF86AudioPlay", function () awful.spawn("mpc toggle") end,
              {description = "mpc toggle (play/pause) song", group = "hotkeys"}),
    awful.key({                   }, "XF86AudioPrev", function () awful.spawn("mpc prev") end,
              {description = "mpc prev song", group = "hotkeys"}),
